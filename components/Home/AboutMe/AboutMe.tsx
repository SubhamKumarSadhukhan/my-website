...
export default function AboutMe(props) {
  const technologies = [
    ["Next.js", "JavaScript (ES6+)", "Tailwind CSS", "Ether.js", "Solidity","Kubernetes","Docker","Express"],
    ["Node.js", "TypeScript", "Framer Motion", "react-moralis", "web3.js","Jenkins","Mongodb","Postgress Sql","InfluxDB"],
  ];
  return (
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Subham, and I am a passionate software engineer and problem solver, dedicated to
                creating impactful codes that thrive on the internet. My journey in computer science began in 2019 when
                I started as a Computer Application Student.
              </span>
            </div>
            <div className="font-Header ">
              <span className="text-gray-400 ">
                ...
                <span className="text-AAsecondary">0xytocin ventures private limited</span>, where I played a key role in releasing minting backend and art generation{" "}
                <span className="text-AAsecondary">Project Godjira</span> , my passion for web3 and continuous
